...
def getHashTagMedia(params):
    ...
    endpointParams = dict()
    endpointParams['user_id'] = params['instagram_account_id']
    endpointParams['fields'] = 'id,children,caption,comment_count,like_count,created_time,media_type,media_url,permalink'
...
print('---- Hashtag Info----')
print('Hashtag:', response['json_data']['data'][0]['name'])
print('Hashtag ID:', response['json_data']['data'][0]['id'])
...
#print(topmediaresponse['json_data']['data'][0].keys())
